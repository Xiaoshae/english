...
注：它们也可以作实义动词，be（存在）、do（做）、have（有），不要将它们的助动词和实义动词弄混淆。
...
助动词只能起辅助作用，并没有实际含义。例如：

The rabbit will kill a wolf. （这兔子将要杀死一只狼）

这里的 will 没有实际含义，只是表示这是一般过去时。



情态动词则含有实际意义：

The rabbit can kill a wolf. （这兔子可以杀死一只狼）

这里的 can 表示有可能，具有实际意义。 
...
核心部分为 **is able to eat** ，结构看上去像是 助动词(be/have/do...)+ 形容词 + 动词不定式（to + 动词原形），然是如何这么拆解的话，这个句子就没有 谓语动词了。
...
3. **be 的过去分词（没有变位）**：been

4. **be 的现在分词（没有变位）**：being
